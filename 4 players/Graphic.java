...
public class Graphic extends JPanel {
    ...
    void setChanges(int numberOfPlayers,String[][] squares,long[][] presents,int n,int[][] posePlayer,String[] score,String[] timee,String[] direction,int[][] theBomb_xy1,int [][]theBomb_xy2){
