...
public class GUI extends JPanel {
    ...
    int [][]bombs=null;
    String[] score=null;
    GUI(String[][] squares,int[][] presents,int n ,String[] Score,String[] presentType,int[][] posePlayer,int [][] bombs){
        ...
        System.out.println(bombs[1][5]+"nn");
        this.bombs=bombs;
    }
    ...
    public void paint(Graphics g) {
        ...
        try {
            ...
            player_red=ImageIO.read(new File("C:\\Users\\asus\\Desktop\\star140.png"));
            player_blue=ImageIO.read(new File("C:\\Users\\asus\\Desktop\\star240.png"));
            player_black=ImageIO.read(new File("C:\\Users\\asus\\Desktop\\star340.png"));
            bomb=ImageIO.read(new File("C:\\Users\\asus\\Desktop\\bomb1.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        int x = 0, y =100;
        ...
        for(int m=0 ;m<6;m++){
            ...
            g.drawImage(bomb,bombs[0][m]*60,bombs[1][m]*60+100,null);
        }
