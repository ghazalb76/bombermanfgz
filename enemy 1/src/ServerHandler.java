...
public class ServerHandler implements  Runnable {
    ...
    public ServerHandler() {
        ...
        mapGenerator.setenemy();

     //   gameManagement.board.setenemy();
        gameManagement.board.makeenemy(mapGenerator.enemy_x,mapGenerator.enemy_y);
    ...
    void logic(int countConnection,Data data){
        ...
        if(countConnection==1){
            ...
            gameManagement.checkenemymove(gameManagement.board.enemies);
        }
        else{
            if(data.keyBoard.equals("5"))
        ...
        gameManagement.checkenemykill(gameManagement.board.enemies);
       /* keyboard1="5";
        if(keyboard1=="5")
            gameManagement.checkBomb(gameManagement.board.player1);
        if (keyboard2=="5")
