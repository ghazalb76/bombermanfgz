...
public class ParseC {
    ...
    void parseScore(){
        try{
            ...
            Object obj = parser.parse(new FileReader("C:\\Users\\dude\\Desktop\\r.txt"));
            JSONObject js = (JSONObject) obj;
            JSONArray scooores=(JSONArray) js.get("score");
            Iterator<String > iterator=scooores.iterator();
            score=new String[4];
            for(int i =0 ;i<4 ;i++){
                score[i]=iterator.next();
            }
            for(int i =0 ;i<n ;i++){
    ...
    void parseTime(){
        try{
            ...
            Object obj = parser.parse(new FileReader("C:\\Users\\dude\\Desktop\\r.txt"));
            JSONObject js = (JSONObject) obj;
            JSONArray timeee=(JSONArray) js.get("time");
            Iterator<String > iterator=timeee.iterator();
            time=new String[2];
            for(int i =0 ;i<2 ;i++){
                time[i]=iterator.next();
            }
            for(int i =0 ;i<2 ;i++){
